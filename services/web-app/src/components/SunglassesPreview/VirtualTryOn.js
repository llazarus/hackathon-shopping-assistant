...
import jac47814 from "../../Images/jac47814.png";
import jar100219 from "../../Images/jar100219.png";
  ...
  useEffect(() => {
    const loadResources = async () => {
      try {
        ...
        console.log(glassesSrc)
        let glassesUrl = jac47814;
        if (glassesSrc == "jar100219.png") {
          glassesUrl = jar100219;
        }

        // Glasses Mesh
        const textureLoader = new THREE.TextureLoader();
        textureLoader.load(glassesUrl , (texture) => {
